...
export default function Botao_Perfil(valores) {
        ...
        return (
            <Pressable  style = {styles.Btn_Entrar}  onPress={valores.funcao} >
                ...
                <View style = {styles.container_imagem_on}> 
                    <Image
                        style = {styles.image}
                        source = {require("../assets/images/perfil_on.png")}
                    />
                </View>
                <Text style = {styles.texto_botao_on}>Perfil</Text>
            </Pressable>
        );
    }
    else{
        ...
        return (
            <Pressable  style = {styles.Btn_Entrar}  onPress={valores.funcao} >
                ...
                <View style = {styles.container_imagem_off}> 
                    <Image
                        style = {styles.image}
                        source = {require("../assets/images/perfil_off.png")}
                    />
                </View>
                <Text style = {styles.texto_botao_off}>Perfil</Text>
            </Pressable>
        );
    }
